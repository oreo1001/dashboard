    ...
    <div className="mx-auto max-w-[900px] p-12">
      ...
      <div>
        ...
        <div className="pt-4 text-lg">
          <div>
            Our Privacy Policy governs your visit to https://www.blockit.com/
            and explains how we collect, safeguard and disclose information that
            results from your use of our Service.{' '}
          </div>
          <div className="pt-8">
            We use your data to provide and improve Blockit. By using Blockit,
          ...
          <div className="pt-8">
            Our Terms and Conditions (“Terms”) govern all use of Blockit and
        ...
        <div>
          ...
          <Def
            title="SERVICE"
            content="means the https://www.blockit.com/ website operated by Blockit AI, LLC"
          ></Def>
          <Def
            title="PERSONAL DATA"
          ...
          <Def
            title="USAGE DATA"
            content="is data collected automatically either generated by the use of Blockit or from the Blockit infrastructure itself (for example, the duration of a page visit)."
          ></Def>
          <Def
            title="COOKIES"
          ...
          <Def
            title="THE USER"
            content="is the individual using Blockit. The User corresponds to the Data Subject, who is the subject of Personal Data."
          ></Def>
        </div>
        <div>
          ...
          <div className="list-decimal text-lg pt-4">
            ...
            <CustomList
              ...
              descriptionList={[
                ...
                "Foundation Model Providers: When you add Blockit to an email, we use OpenAI’s GPT models to parse the thread. This enables us to take the correct action on your behalf. Any information in the emails that Blockit is cc'd on will be shared with OpenAI. OpenAI's use of your personal information is governed by their Privacy Policy, which can be found at  OpenAI Privacy Policy",
              ]}
            />
            <CustomList
