  ...
  return (
    <div className="flex flex-col justify-start items-center">
      <div className="flex flex-col items-center w-full bg-[url('/assets/main1.png')] bg-cover bg-center h-64 sm:h-96 md:h-[400px] lg:h-[500px] xl:h-[700px]">
        ...
        <div className="max-w-[1200px] w-full sm:pt-24 md:pt-28 lg:pt-32 xl:pt-[300px] flex flex-col justify-start items-start px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
